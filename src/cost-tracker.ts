...
function readState(): CostState | null {
  try {
...
function writeState(state: CostState): void {
  try {
...
export function computeCost(usage: TokenUsage | null | undefined): number {
  if (!usage) return 0;
 ...
 */
export function getWindowCost(
  currentUsage: TokenUsage | null | undefined,
